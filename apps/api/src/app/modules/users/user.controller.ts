...
import { SignUpDto } from '../../../../../../libs/entity-data-models/src/dtos/sign-up.dto';
import { GetUserDto } from '../../../../../../libs/entity-data-models/src/dtos/user-get.dto';
import { UpdateUserDto } from '../../../../../../libs/entity-data-models/src/dtos/user-update.dto';
import { ControllerAbstract } from '../../core/factories/abstract.controller';
import {
  ApiUrls,
  ApiUserUrls,
} from './../../../../../../libs/entity-data-models/src/enums/api-urls.enum';
import {
  buildFindOneOptions,
  decryptPassword,
} from './../../../../../../libs/entity-data-models/src/utils/encryptation';
import { ResponseBuilderService } from './../../../../../../libs/ngx-shared/src/lib/services/response-builder.service';
...
export class UserController extends ControllerAbstract<User> {
  lang = 'es';
  constructor(
  ...
  @Get()
  public findAll(@Headers() headers, @Res() response): Promise<User[]> {
  ...
  public findByPropertie(
    ...
    return this.userService.findByPropertie(propertieObject).then((user) => {
      const userWithoutPassword: GetUserDto = {
        id: user.id.toString(),
        name: user.name,
        surname: user.surname,
